...
{isNovoModalOpen &&(
        ...
        <Box styleSheet={{padding: !(size < 600) ? '4rem 6.5rem' : '4rem 20px'}}>
            <Text variant="heading2Bold" styleSheet={{fontSize: !(size < 600) ? '2.2rem' : '1.5rem'}}>Termos e condições gerais de uso</Text>
